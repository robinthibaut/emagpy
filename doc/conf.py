...
example_gallery_config = {
    ...
    "dont_preprocess": [
        "../jupyter-notebook/nb_comparison-inversion-cover-crop.ipynb",
        "../jupyter-notebook/nb_paper-cs-vs-fs.ipynb",
        "../jupyter-notebook/nb_paper-noise-height.ipynb",
        "../jupyter-notebook/nb_paper-ert-calibration.ipynb",
        "../jupyter-notebook/nb_paper-river-fdem.ipynb",
        "../jupyter-notebook/nb_multi-frequency.ipynb",
    ],
    "pattern": "nb_.+.ipynb",
...
latex_documents = [
    (
        master_doc,
        "emagpy.tex",
        "EMagPy Documentation",
        "G. Blanchy and P. McLachlan",
        "manual",
    ),
]
...
man_pages = [(master_doc, "emagpy", "EMagPy Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "EMagPy",
        "Processing and inversion of EMI data (FDEM)",
